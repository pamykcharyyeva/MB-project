...
class NewslettersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create newsletter" do
    assert_difference('Newsletter.count') do
      post newsletters_url, params: { newsletter: { author: @newsletter.author, date: @newsletter.date, html: @newsletter.html } }
    end
  ...
  test "should update newsletter" do
    patch newsletter_url(@newsletter), params: { newsletter: { author: @newsletter.author, date: @newsletter.date, html: @newsletter.html } }
